...
class DaemonNodeRegistry:
    ...
    def _enqueue_current_assignment(
        ...
        *,
        ...
        # Artifact collection belongs to the daemon, including old runtimes.
        # Never interpret a daemon workspace path as a backend-host directory.
        command["_artifactSnapshot"] = None
    ...
    def _record_generated_workspace_artifacts(
        ...
        if isinstance(event.get("generatedFiles"), list):
            ...
            # filesystem walk could disclose unrelated backend files.
            items = []
